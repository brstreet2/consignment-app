...
<body>
    ...
    <div class="d-none d-xxl-block sticky-top">
        <nav class="navbar navbar-light p-2" style="background-color: #121727f5; backdrop-filter: blur(13.59px);">
            <div class="container ">
                            ...
                            @else
                                <div class="">
                                    <a href="{{ route('auth.index') }}"
                                        class="btn btn-warning position-relative h-100 px-4 py-2">
                                        Masuk
                                    </a>
                                </div>
                                ...
                                <div class="">
                                    <a href="{{ route('auth.index') }}"
                                        class=" btn btn-light btn-hover position-relative h-100 px-4 py-2">
                                        Daftar
                                    </a>
                                </div>
                ...
                <div class="col-md-6 d-flex">
                    <div class="col-md-6">
                        <form class="d-flex">
                            <div class="input-group">
                                ...
                                <input type="search"
                                    class="form-control btn btn-outline-dark py-2 text-light shadow-none text-start"
                    ...
                    <div class="col-md-6 ">
                        <div class="col-md-12 d-flex justify-content-evenly">
                            ...
                            <div class="">
                                <a href="{{ route('auth.index') }}"
                                    class=" btn btn-dark position-relative h-100 px-4 py-2"
                    ...
                    <div class="col-md-5 ">
                        <div class="col-md-12 d-flex">
                            ...
                            <div class="col-md-5 text-end">
                                <a href="{{ route('auth.index') }}"
                                    class=" btn btn-dark position-relative h-100 px-2 py-2"
                                    style="background-color: #ffa842; border-radius: 10px">
                                    Masuk
                                </a>
                            </div>
                            ...
                            <div class="col-md-5 text-center">
                                <a href="{{ route('auth.index') }}"
                                    class=" btn btn-light btn-hover position-relative h-100 px-2 py-2"
                                    style="background-color: #FFF6E0; border-radius: 10px; color: #ffa842">
                                    Daftar
                                </a>
                            </div>
