    ...
    <div id="carouselExampleControls" class="carousel slide p-3" data-bs-ride="carousel">
        <div class="carousel-inner container">
            <div class="carousel-item active">
                ...
                <img src="https://oogamerstore.com/assets/images/banner/1709689558_3d07d7713272e97164d4.png" class="img-fluid d-block mx-auto w-100"  style="border-radius: 20px; max-height: 24rem" alt="...">
            </div>
