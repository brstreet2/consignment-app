...
<div class="d-none d-lg-block">
    <div class="container mt-4">
        <div class="row d-flex justify-content-around">
            {{-- kiri --}}
            <div class="col-4">
                <div class="p-4 card card-dark my-2 rounded-5 text-light text-center bg-dark-secondary">
                    ...
                    <div>
                        ...
                        {{-- <p class="fs-5 fw-bold">20 Juni 2024 (11:53 PM)</p> --}}
                    ...
                    <div class="mt-5">
                        <img src="{{ asset('images/payments/qr-code.jpg') }}" class="w-100" alt="">
                    </div>
                </div>
            </div>
            ...
            {{-- kanan --}}
            <div class="col-8">
                <div class="card p-4 my-2 rounded-5 bg-dark-secondary">
                    <div class="row">
                        <div class="col-3">
                ...
                <div class="p-4 rounded-5 my-4 bg-dark-secondary">
